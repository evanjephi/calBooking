  ...
  return (
    <div className="public-page">
      <div className="public-hero">
        <h1>PSW Learning and Development Hub</h1>
        <p>
          PSWs benefit from continuous learning opportunities through our dedicated content
          library. Each article and guide is designed to support your growth, professionalism,
          and confidence as a Personal Support Worker.
        </p>
      </div>
      ...
      <div className="hub-content">
        ...
        <div className="hub-cta">
          ...
          <p>Join our platform and connect with families and healthcare institutions who need your services.</p>
